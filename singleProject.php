...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <div class="media">
      <div class="media-left" onclick="startChat(<?php echo $board_row_RecBoard['m_id'] * 1; ?>, '<?php echo $board_row_RecBoard["boardname"]; ?>')">
        <img data-src="holder.js/40x40/text:K" class="img-circle" ><br>
        <?php echo $board_row_RecBoard["boardname"]; ?>
      </div>
